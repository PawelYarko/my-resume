...
const userName = document.querySelector('#call-back-input-name');
const userEmail = document.querySelector('#call-back-input-email');
const userPhone = document.querySelector('#call-back-input-phone');
